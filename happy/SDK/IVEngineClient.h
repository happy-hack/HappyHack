...
public:
	...
	void ClientCmd_Unrestricted(char const* cmd)
	{
		...
		(*(original_fn * *)this)[114](this, cmd);

	}
	Vector get_view_angles() {
		Vector temp;
		using original_fn = void(__thiscall*)(IVEngineClient*, Vector&);
	...
	const matrix3x4_t2& GetMatrix()
	{
		using original_fn = const matrix3x4_t2& (__thiscall*)(IVEngineClient*);
